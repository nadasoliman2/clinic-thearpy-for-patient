      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-border">
          ...
          <div className="bg-gradient-to-r from-[#09b6ab] to-[#07a89d] p-8 md:p-8 text-white">
            {currentView === 'main' && (
              <>
                <h3 className="font-bold mb-3 text-balance" dir='rtl'>احجز جلستك الآن</h3>
                <p className="text-white/90 text-lg" dir='rtl'>اختر خياراً لإدارة مواعيدك</p>
              </>
            )}
            ...
            {currentView === 'reschedule' && (
              <>
                <h2 className=" font-bold mb-3 text-balance"dir='rtl'>إعادة جدولة الموعد</h2>
                <p className="text-white/90 text-lg"dir='rtl'>اختر تاريخاً ووقتاً جديداً</p>
              </>
            )}
          </div>
