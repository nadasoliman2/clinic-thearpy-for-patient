  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4 md:p-8" dir="rtl">
      ...
      {step === 'location' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
          <div>
            <h3 className=" font-bold text-gray-900 mb-3 text-balance">اختر الموقع</h3>
      ...
      {step === 'therapist' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
          <div>
            <h3 className="  font-bold text-gray-900 mb-3 text-balance">اختر المعالج</h3>
      ...
      {step === 'date' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
          <div>
            <h3 className="  font-bold text-gray-900 mb-3 text-balance">اختر التاريخ</h3>
      ...
      {step === 'time' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
          <div>
            <h3 className="  font-bold text-gray-900 mb-3 text-balance">اختر الوقت</h3>
      ...
      {step === 'patient' && (
        <form onSubmit={handleSubmit(handleConfirmBooking)} className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
          <div>
            <h3 className="  font-bold text-gray-900 mb-3 text-balance">أكمل البيانات</h3>
      ...
      {step === 'confirmation' && (
        <div className="text-center space-y-8 py-12 animate-in fade-in slide-in-from-bottom-4">
          ...
          <div>
            <h2 className="  font-bold text-green-700 mb-2 text-balance">تم الحجز بنجاح!</h2>
          ...
          <div className="bg-gradient-to-br from-[#09b6ab]/10 to-[#07a89d]/5 border-2 border-[#09b6ab]/30 p-8 rounded-xl inline-block max-w-md mx-auto w-full">
            ...
            <p className=" font-black  text-3xl text-[#09b6ab] tracking-widest font-mono">{bookingId}</p>
